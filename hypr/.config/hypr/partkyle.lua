...
hl.animation({ leaf = "layers", enabled = true, speed = 12, bezier = "snappy" })
hl.animation({ leaf = "layersIn", enabled = true, speed = 12, bezier = "snappy", style = "fade" })
hl.animation({ leaf = "layersOut", enabled = true, speed = 10, bezier = "linear", style = "fade" })
hl.animation({ leaf = "fadeLayersIn", enabled = true, speed = 12, bezier = "snappy" })
hl.animation({ leaf = "fadeLayersOut", enabled = true, speed = 10, bezier = "snappy" })
